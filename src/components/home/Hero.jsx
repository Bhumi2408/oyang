    ...
    <div className="relative w-full min-h-screen">
      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-10 lg:gap-10 min-h-screen text-white px-6 sm:px-10 lg:px-24 py-20 lg:py-16">
        ...
        <motion.div
          ...
          className="relative w-full max-w-[400px] sm:max-w-[500px] lg:max-w-none lg:w-auto mt-6 lg:mt-0"
        >
          ...
          />
          <div className="absolute -bottom-4 sm:-bottom-5 -left-4 sm:-left-5 bg-white p-4 sm:p-6 rounded-lg border-gray-300 border-2">

...
export default function Leadership() {
  return (
    <section className="py-24 px-10 lg:px-24 bg-[#f8fafc] text-center">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-7 mt-14">
        {leaders.map((person, index) => (
          ...
          >
            <div className="relative w-full h-[340px] bg-gradient-to-br from-primary to-secondary">
              <Image
                src={person.image}
                alt={person.name}
                fill
            ...
            <div className="p-5">
              <h3 className="font-extrabold text-[#0f172a]">{person.name}</h3>
